...
date student::get_ddn() {return ddn;}
grade student::get_g1() {return g1;}
grade student::get_g2() {return g2;}
grade student::get_g3() {return g3;}
...
double student::calculate_average() {double a;a=((g1.grade::get_n()*g1.grade::get_coef())+(g2.grade::get_n()*g2.grade::get_coef())+(g3.grade::get_n()*g3.grade::get_coef()))/(g1.grade::get_coef()+g2.grade::get_coef()+g3.grade::get_coef());return a;}
